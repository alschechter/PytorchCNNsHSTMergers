...
#from optuna test 1 {'learning_rate': 6.821279815426123e-08, 'optimizer': 'SGD'}
learning_rate = 2.5*1e-8
...
def draw_curve(current_epoch):
    ...
    if current_epoch == 0:
        ...
        ax1.legend()
    plt.tight_layout()
    fig.savefig('metrics_custom_transfer_Adam' + str(learning_rate) + 'moredropout.png')
